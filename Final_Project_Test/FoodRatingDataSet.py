...
class FoodRatingDataset:
    ...
    def __init__(self):
        ...
        self.dataset = tf.data.Dataset.from_generator(self.new.genData,output_signature=((tf.TensorSpec(shape=(1, 9), dtype=tf.int32),tf.TensorSpec(shape=(1,9,8023), dtype=tf.int32),tf.TensorSpec(shape=(1,9,3), dtype=tf.int32)),tf.TensorSpec(shape=(1,178265), dtype=tf.int32)))
